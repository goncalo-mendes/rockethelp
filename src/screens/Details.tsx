  ...
  return (
    <VStack flex={1} bg="gray.700">
      ...
      <ScrollView mx={5} showsVerticalScrollIndicator={false}>
        ...
        <CardDetails title="Descrição" description={`${order.descriptions}`} icon={Clipboard} footer={order.when} />
        <CardDetails
          title="Solução"
      ...
      {!order.closed && <Button title="Finalizar" m={5} onPress={handleOrderClosed} />}
    </VStack>
  );
}
